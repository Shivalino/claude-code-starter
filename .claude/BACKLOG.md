...
> 📋 **SINGLE SOURCE OF TRUTH для ближайшей работы над фреймворком**
>
> Этот файл содержит:
> - 🎯 Текущие задачи (что делаем прямо сейчас)
> - 🔥 Priority 1 (ближайшие критические улучшения)
> - 📚 Архив (завершённые фазы)
>
> 🗺️ **Долгосрочное планирование:** см. [README Roadmap](../README.md#-roadmap) (v2.1, v2.2, v3.0)
...
> Задачи и идеи для ближайших версий (v2.1.x - v2.2)
> Долгосрочные идеи (v3.0+) см. в [README Roadmap](../README.md#-roadmap)
...
- #8: Стандартизация формата GitHub Issues
- #41: Пояснение к 'Continue or commit first?' в Cold Start Protocol
